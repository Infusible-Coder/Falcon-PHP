    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <div class="nav-link">
          ...
          <span style="font-size: large; color: white;">Falcon Workshop</span>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="status.php">
          ...
          <span style="font-size: 16px;">Status Wise</span></a>
      </li>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-2">
            <div class="card-header py-2">
              ...
              <form method="POST" action="store-view.php" style="text-align: center;">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                  ...
                  ?>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        $result = mysqli_query($mysqli, "SELECT * FROM  items  WHERE month='$month' AND year='$year' ORDER BY id DESC");
                ...
                <!---------------------------------all---------------------->
              <?php } else { ?>
                <h6 style="text-align: center; color: blue;">All Records</h6>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <?php
                    $i = 2400;
                    $result = "SELECT * FROM items ORDER BY id DESC";
