...
<hr class="sidebar-divider">
          ...
          <!-- Nav Item - Charts -->
          <!-- <li class="nav-item">
        <a class="nav-link" href="show-all-stu.php">
          <i class="fas fa-globe-asia" style="font-size: 18px;"></i>
          <span style="font-size: 18px;"> Monthly </span></a>
      </li> -->
...
$i = 2400;
  ...
  ?>
                  ...
                  <td>
                    <!-- <a href="public/add-category-form.php?edit=<?php echo $data['id']; ?>" class="btn btn-info">Edit</a> -->
                    <!-- <a href="public/process.php?delete7=<?php echo $data['id']; ?>" class="btn btn-danger">Delete</a></td>  -->
