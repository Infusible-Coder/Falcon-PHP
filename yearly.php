...
<div class="card position-relative">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Year Wise</h6>
    </div>
    <div class="card-body">
      <div class="mb-3">
      <form method="POST" action="yearly.php"  style="text-align: center;">
...
?>
<h6 style="text-align: center; color: blue;"><?php echo $year ?></h6>

<?php
$result=mysqli_query($mysqli,"SELECT SUM(Amount) AS amount FROM items WHERE `year` = '".$year."'");
$result1=mysqli_query($mysqli,"SELECT SUM(Balance) AS balance FROM items WHERE `year` = '".$year."'");
...
?>
<h6 style="text-align: center; color: blue;">current year</h6>
